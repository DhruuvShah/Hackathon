  ...
  return (
    <div className="pt-20">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://shop.centr.com/cdn/shop/files/CEN25_0614-Category_page_DESKTOP_ACCESSORIES.jpg?v=1752112441&width=2000')",
        }}
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
          <RevealOnScroll>
            ...
            <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-300">
              Elevate your training with our collection of workout essentials,
              designed to add versatility and intensity to any routine.
            </p>
          </RevealOnScroll>
        </div>
      </section>
            ...
            {accessoriesProductsData.map((product, index) => (
              <RevealOnScroll key={product.id} delay={index * 50}>
                <Link
                  ...
                  className="glass-effect rounded-3xl overflow-hidden group flex flex-col h-full transition-all duration-300 hover:shadow-2xl hover:shadow-blue-600/20 hover:-translate-y-2"
                >
