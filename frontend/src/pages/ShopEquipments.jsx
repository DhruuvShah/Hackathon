...
const productsData = [
  { id: 1, name: 'Centr 1 Home Gym', price: '$2,499.99', img: 'https://shop.centr.com/cdn/shop/files/centr-1-home-gym-functional-trainer-499512.jpg?v=1724214568&width=1200', category: 'Home Gyms' },
  { id: 2, name: 'Centr Hex Dumbbells', price: '$19.99', img: 'https://shop.centr.com/cdn/shop/files/centr-hex-dumbbells-347924.jpg?v=1738030634&width=1200', category: 'Weights' },
  { id: 3, name: 'Centr RUNR Treadmill', price: '$1,199.99', img: 'https://shop.centr.com/cdn/shop/files/centr-runr-742140.jpg?v=1739902523&width=1200', category: 'Cardio' },
];
  ...
  return (
    <div className="pt-20">
      ...
      <section
        ...
        style={{ backgroundImage: "url('https://shop.centr.com/cdn/shop/files/Centr-RUNR-S-2500x900.webp?v=1728602389&width=2000')" }}
      >
